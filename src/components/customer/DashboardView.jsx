...
const FEATURED = [
  { id: 1, title: 'Atomic Habits', author: 'James Clear', cover: 'bg-purple-500/40', price: '$14.99', badge: 'Bestseller', rating: '★★★★★' },
  { id: 2, title: 'The Midnight Library', author: 'Matt Haig', cover: 'bg-blue-500/40', price: '$12.99', badge: 'Staff Pick', rating: '★★★★' },
  { id: 3, title: 'Project Hail Mary', author: 'Andy Weir', cover: 'bg-emerald-500/40', price: '$15.99', badge: 'New', rating: '★★★★★' },
  { id: 4, title: 'Deep Work', author: 'Cal Newport', cover: 'bg-amber-500/40', price: '$11.99', badge: 'Popular', rating: '★★★★' },
  { id: 5, title: 'The Alchemist', author: 'Paulo Coelho', cover: 'bg-pink-500/40', price: '$9.99', badge: 'Classic', rating: '★★★★★' },
];

const DashboardView = ({ onNavigate, onPreview }) => {
