    ...
    <div className="space-y-6">
      ...
      {books.length === 0 ? (
        ...
        <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
          {books.map((book) => (
            <div key={book.id || book.key} className="group relative flex flex-col rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur transition hover:border-purple-500/30 hover:bg-white/10">
              ...
              <div className="mt-4 flex flex-1 flex-col">
                <h4 className="line-clamp-1 text-base font-semibold text-white">{book.title}</h4>
                <p className="line-clamp-1 text-sm text-purple-300">{book.author}</p>
                ...
                <div className="mt-auto pt-4 flex gap-2">
                  ...
                  <button
                    ...
                    className="flex-1 rounded-lg bg-white/5 py-2 text-xs text-gray-400 transition hover:bg-white/10 hover:text-red-400"
                  >
                    Remove
                  </button>
                </div>
